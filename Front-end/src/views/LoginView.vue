        ...
        >
          ...
          <el-form-item>
            ...
            <div class="register-tip">
              还没有账号？<a @click.prevent="goRegister">去注册</a>
            </div>
          </el-form-item>
        </el-form>
      </el-card>
...
.gradient {
  ...
  background: linear-gradient(120deg, #7C3AED, #2563EB, #10B981, #F59E0B, #EF4444);
  background-size: 300% 300%;
  animation: gradientShift 12s ease infinite;
  filter: blur(40px) opacity(0.6);
}

.blob { position:absolute; border-radius:50%; filter: blur(24px); opacity:0.55; }
.blob-1 { width: 360px; height:360px; background:#60A5FA; top:-120px; right:-120px; }
.blob-2 { width: 240px; height:240px; background:#F472B6; bottom:-80px; left:-80px; }
.blob-3 { width: 180px; height:180px; background:#34D399; top: 20%; left: 12%; }
...
.login-btn {
  width: 100%; height: 44px; font-size: 16px; margin-top: 16px;
...
.register-tip a { color: #409eff; cursor: pointer; }
